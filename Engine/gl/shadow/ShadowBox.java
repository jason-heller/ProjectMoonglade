...
public class ShadowBox {
	...
	public static float shadowDistance = 16;
	...
	protected void update(Camera camera) {
		...
		Vector3f toFar = Vector3f.mul(forwardVector, shadowDistance);
		Vector3f toNear = Vector3f.mul(forwardVector, Camera.NEAR_PLANE);
		...
		maxZ += OFFSET;
		//Console.log((int)getCenter().x, (int)getCenter().y, (int)getCenter().z);
	}
