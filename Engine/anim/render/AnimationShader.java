...
public class AnimationShader extends ShaderProgram {
	...
	private static final String VERTEX_SHADER = "animation/renderer/animVertex.glsl";
	private static final String FRAGMENT_SHADER = "animation/renderer/animFragment.glsl";
