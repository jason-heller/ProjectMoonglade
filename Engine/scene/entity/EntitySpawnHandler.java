...
public class EntitySpawnHandler {
	...
	private final int MIN_SPAWN_RAD = 48, SPAWN_RANGE = 64;
	...
	public EntitySpawnHandler(Enviroment enviroment, Terrain terrain) {
		...
		// TODO: stop using ints
		spawnable = new int[] {2, 7};
	}
	...
	private void attemptSpawn() {
		...
		if ((spawnRng.nextInt() & entity.getSpawnRarity()) != 0) {
			entity.destroy();
			return;
		}
		...
		if (entity.spawnConditionsMet(enviroment, terrain, chunk, x, z, dx, terrainHeight, dz)) {
