...
public class GraphicsPanel extends GuiPanel {
	...
	private final GuiSlider fov, fps, particleCount, chunkRender;
	private final GuiSpinner fullscreen;
	...
	public GraphicsPanel(GuiPanel parent, int x, int y) {
		...
		chunkRender = new GuiSlider(x, y, "Render distance", 3, 17, Globals.chunkRenderDist, 2);
